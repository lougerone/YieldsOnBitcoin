...
// YieldMaxxer: Pendle 14% * 30% + BounceBit 24% * 25% + Solv 6.6% * 25% + Merlin 18% * 20% = 14.5%
export const STRATEGIES = [
  ...
  { name: "YieldMaxxer", description: "Maximum APY. Yield trading and CeDeFi strategies on Bitcoin.", icon: "🚀", allocations: [{ id: 4, pct: 30 }, { id: 8, pct: 25 }, { id: 3, pct: 25 }, { id: 22, pct: 20 }], expectedApy: 14.5, riskLevel: "High" },
];
