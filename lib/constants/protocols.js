...
export const PROTOCOL_CONFIG = [
  ...
  },
  {
    ...
    tvl: 1170, // DeFiLlama: $1.17B ($1.14B on Bitcoin via Babylon)
    risk: "Low",
    chain: "Multi-chain",
    lockup: "None",
    minDeposit: 0.0002,
    description: "LBTC liquid staking token backed 1:1 by BTC staked via Babylon. Base APY ~0.4%, use LBTC in DeFi for additional yield.",
  ...
  },
  {
    ...
    apy: 7.17,
    apyRange: null, // Variable stacking rate
    baseApy: 4.0,
    baseApyRange: null, // Variable
    tokenRewards: { token: "STX", apy: 3.17, note: "BTC rewards from miners paid in STX value" },
    tvl: 355, // DeFiLlama verified: $355M (stacks-sbtc)
    risk: "Low",
    chain: "Stacks L2",
    lockup: "14 days",
    minDeposit: 0.001,
    description: "Earn ~7.17% APY via stacking. Base BTC yield ~4% + STX rewards ~3%. sBTC dual stacking available.",
...
// Native: Babylon 13.5% * 35% + Stacks 7.17% * 30% + Botanix 6.5% * 25% + Mezo 7% * 10% = 9.2%
...
export const STRATEGIES = [
  { name: "Native", description: "Pure Bitcoin staking. No wrapping, no bridges. Native BTC yields from L2s.", icon: "₿", allocations: [{ id: 1, pct: 35 }, { id: 5, pct: 30 }, { id: 13, pct: 25 }, { id: 10, pct: 10 }], expectedApy: 9.2, riskLevel: "Low" },
